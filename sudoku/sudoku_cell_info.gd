...
func set_is_player_cell(is_player_cell_: bool) -> void: _is_player_cell = is_player_cell_

func is_player_cell() -> bool: return _is_player_cell

#func set_solver_value(value: int) -> void: _solver_value = value

#func clear_solver_value() -> void: _solver_value = Utilties.Sudoku_Cell_Alts.EMPTY

#func has_solver_value() -> bool: _solver_value != Utilties.Sudoku_Cell_Alts.EMPTY
